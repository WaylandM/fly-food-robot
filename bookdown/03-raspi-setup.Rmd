...
Minicom is useful for manual control of the robot and for editing grbl settings. Before installing minicom, make sure the raspberry pi is connected to the arduino via the usb cable.
