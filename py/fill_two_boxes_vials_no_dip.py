...
x101 = -8 # previous value -5
y101 = -286 # previous value -285
x200 = -236 # previous value -240
y200 = -513 # previous value -520
nrows = 10
ncols = 10

f = open('../nc/2_boxes_vials_no_dip.nc', 'w')

f.write('(gcode instructions to fill two boxes of 100 vials.)\n')
...
# -1.0 to ensure converted to float
x_interval = (x200 - x101)/(ncols-1.0)
y_interval = (y200 - y101)/(nrows-1.0)
