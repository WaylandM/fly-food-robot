...
\item
  ...
  you have finished configuring Grbl.
\end{itemize}
...
\section{Install python scripts}\label{install-python-scripts}
...
\section{Determine box coordinates}\label{determine-box-coordinates}
...
First we need to determine the Cartesian coordinates of the first and
last vial in each box.
...
\end{verbatim}
\item
  First we will determine the Cartesian coordinates of the first vial in
  the first box; this is the vial in the front left corner.
\end{enumerate}
...
\item
  ...
  the top of the first vial (figure ), \emph{e.g.}:
...
box1\_first\_vial.jpg box1\_last\_vial.jpg box2\_first\_vial.jpg
box2\_last\_vial.jpg
