...
boxRow <- seq(1,10)
fillTime <- c(0.2, 0.24, 0.29, 0.33, 0.38, 0.42, 0.47, 0.51, 0.56, 0.6)
...
Once the pump has been calibrated we are ready to generate the G-code instructions for filling v
