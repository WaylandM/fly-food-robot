...
```{r actuatorsCentred, echo=FALSE, out.width='75%', fig.align='center', fig.cap="Actuator carriages centred in preparation for powering-up motors for first time"}
...
```{r serialMonitor, echo=FALSE, out.width='75%', fig.align='center', fig.cap="Arduino IDE Serial Monitor"}
knitr::include_graphics("images/Arduino_IDE_serial_monitor.png")
```
...
```{r robotOrientation, echo=FALSE, out.width='75%', fig.align='center', fig.cap="Orientation of robot."}
knitr::include_graphics("images/robot_orientation.png")
```
...
| 7 | 00000111 |Y | Y | Y |
 ...
 --->
```{r invertMaskSettings, echo=FALSE}
setting <- 0:7
mask <- c("00000000", "00000001", "00000010", "00000011", "00000100", "00000101", "00000110", "00000111")
invX <- rep(c("N", "Y"),4)
invY <- rep(c("N", "N", "Y", "Y"),2)
invZ <- c(rep(c("N"),4), rep(c("Y"),4))
masks <- as.data.frame(cbind(setting, mask, invX, invY, invZ))
names(masks) <- c("Setting Value", "Mask", "Invert X", "Invert Y", "Invert Z")
knitr::kable(
  masks, booktabs = TRUE,
  caption = 'Masks for direction port inversion.'
)
```
...
```{r xyOrigin, echo=FALSE, out.width='75%', fig.align='center', fig.cap="Origin of XY coordinate system."}
knitr::include_graphics("images/xy_origin.jpg")
```

```{r zOrigin, echo=FALSE, out.width='75%', fig.align='center', fig.cap="Origin of Z axis."}
knitr::include_graphics("images/z_origin.jpg")
```
...
```{r gShield, echo=FALSE, out.width='75%', fig.align='center', fig.cap="gShield trimpots"}
knitr::include_graphics("images/gShield-trimpots.jpg")
```
